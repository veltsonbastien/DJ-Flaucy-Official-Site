        ...
        <ul class = "nav navbar-nav">
          ...
          <li class = "nav-item"><a class = "nav-links" href="games.php">Shop</a></li>   
               ...
               <div class = "video-section" id="video-section"> 
                  <div class = "row">
                    <div class = "col-sm-8"> 
                      <div class = "current-video"> 
                        <div class = "main-section-header"> PHOTOS </div> 
                        <div style ="border: none; text-align: LEFT; margin-top: 30px; color: #fff; margin-left:20px;"> No Posts Yet. </div>
                      </div> 
                    </div>
                    <div class = "col-sm-4"> 
                  ...
                  </div> <!--END OF ROW CONTAINING CURRENT VIDEO AND OTHER VIDEOS --> 
               </div>
